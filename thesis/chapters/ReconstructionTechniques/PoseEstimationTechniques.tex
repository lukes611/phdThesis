...
\section{Fundamental Matrix Method}
...
\subsection{Fast Odometry from Vision: FOVIS}
...
\subsection{Feature Matching, RANSAC and ICP Refinement}
...
\subsection{FOVIS and ICP Integration}
...
\section{Direct Optimization Methods}

\subsection{Optimization over a Signed Distance Function}
...
\subsection{ICP + SDF Optimization}
...
\subsection{Warp Function Optimization} 
...
\subsection{Event Feature Optimization}
...
\subsection{4-Point Congruent Sets}
...
\subsection{Base Shape Matching}
