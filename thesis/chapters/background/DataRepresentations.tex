...
\section{The Point Cloud Representation}
...
Yguel et al [WARNING CHECK REFERENCe] proposed work to compress 3D reconstructions using wavelet compression.
...
\section{Image Based Representations}
