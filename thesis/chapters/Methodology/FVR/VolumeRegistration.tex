...
Here we step into the detail of phase correlation with deeper insight than the superficial introduction in section \ref{Sec:SuperficialPCSection} and with a focus on 3D data and pose estimation. Firstly, we define the correlation measurement process. Correlation in the context of signal processing measures signal shape similarity between two signals. \\
