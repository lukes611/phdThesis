...
double percentMatch(ll_pix3d::Pixel3DSet & a, ll_pix3d::Pixel3DSet & b, double minError = 0.5f);
double percentMatch_1way(ll_pix3d::Pixel3DSet & a, ll_pix3d::Pixel3DSet & b, double minError = 0.5f);
